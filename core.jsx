...
function parseYearStandings(sheet) {
  ...
  // Older DGL sheets store each golfer in a labeled block instead of beneath
  // a single Total DGL Points header. Use the final number in the points row
  // as that player's season total when the column-based layout is unavailable.
  if (!players.length) {
