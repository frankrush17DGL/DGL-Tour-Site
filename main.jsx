...
function parsePlayers(text) {
  ...
  const headerIndex = rows.findIndex(row => {
    ...
    return headers.includes('name') && (
      headers.includes('photourl') ||
      headers.includes('headshoturl') ||
      headers.includes('nickname') ||
  ...
  const value = (row, key) => indexes[key] >= 0 ? textCell(row[indexes[key]]) : '';
...
function parseThisDayHistory(text) {
  ...
  const indexes = {
    ...
    title: headerIndex(headers, ['Title', 'Headline']),
    story: headerIndex(headers, ['Story', 'Description', 'Body']),
    winner: headerIndex(headers, ['Winner', '1st', 'First']),
    second: headerIndex(headers, ['Second', '2nd']),
    third: headerIndex(headers, ['Third', '3rd']),
    fourth: headerIndex(headers, ['Fourth', '4th']),
    net: headerIndex(headers, ['Net Score', 'Net']),
    photoUrl: headerIndex(headers, ['Photo URL', 'Photo', 'Image URL', 'History Photo', 'History Photo URL'])
  };
