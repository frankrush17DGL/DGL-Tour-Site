...
function parseFutureEvents(text) {
  ...
  // Current Future Events tab structure:
  // Row 1: Week
  // Row 2: Event
  // Row 3: Date
  // Row 4: Course
  // Row 5: Time
  // Row 6: Notes / number of commits
  // This function finds rows by the labels in column A instead of relying on brittle row numbers.
  ...
  const notesRow = findRow(['Notes', 'Notes/Number of Commits', 'Number of Commits', 's/number of commits']);

  // If the labels are ever missing, fall back to the exact visual layout from the sheet.
  ...
  for (let col = 1; col < maxCol; col++) {
    ...
    // Only skip truly empty columns. A course alone is enough to show the event.
  ...
  // Preserve sheet order. Future Events is manually curated left-to-right.
  return events;
}
