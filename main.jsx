...
function PlayerTradingCard({ profile }) {
  ...
  function headlineBadge(item) {
    ...
    if (item.stateTrophyWins > 0) return 'STATE TROPHY';
  ...
  return (
    <button
      className={'flip-card opc-flip-card real-card ' + (flipped ? 'is-flipped' : '')}
      ...
      <div className="flip-card-inner opc-card-inner">
        <div className="card-face card-front opc-card-front">
          <div className="opc-card-shell">
            <div className="opc-card-stock"></div>
            ...
            <div className="opc-portrait-disc">
            ...
            <div className="opc-name-zone">
              ...
              <span className="opc-rank-badge">#{profile.rank || cardNo}</span>
            </div>
            ...
            <div className="opc-back-two-col">
              ...
              <section>
                ...
                <dl className="opc-fact-list">
                  ...
                  <div><dt>Favorite Course</dt><dd>{profile.favoriteCourse || '—'}</dd></div>
                  <div><dt>Walk-Up Song</dt><dd>{profile.walkUpSong || '—'}</dd></div>
                </dl>
              </section>
            </div>

            <p className="opc-card-bio"><b>Bio:</b> {profile.bio || 'Bio pending. Add notes in the Players tab to complete the back of this card.'}</p>
            <div className="opc-back-footer"><span>DGL DEBUT: {profile.debutYear || '—'}</span><span>PLAY HARD. GIVE ZERO PUTTS.</span></div>
          </div>
        </div>
      </div>
    </button>
...
function PlayersPage({ data, goHome }) {
  ...
  return (
    <section className="red-room-page players-page card-gallery-page">
      ...
      <div className="players-card-set-title">
