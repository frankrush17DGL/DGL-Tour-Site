...
function parseThisDayHistory(text) {
  ...
  return rows.slice(headerIndex + 1).map(row => {
    ...
    return {
      ...
      photoUrl: indexes.photoUrl >= 0 ? normalizeAssetUrl(row[indexes.photoUrl]) : normalizeAssetUrl(row[13] || '')
    };
  }).filter(Boolean);
}
...
function PlayerPhoto({ name, src = '', className = '' }) {
  ...
  const cleanSrc = normalizeAssetUrl(src);
  const candidates = [
    cleanSrc,
    `/players/${slug}.jpg`,
    `/players/${slug}.jpeg`,
              ...
              return (
                <React.Fragment key={round.player + round.course + round.date + index}>
                  ...
                  >
                    ...
                    <b>{round.photoUrl ? 'View Photo' : round.tier}</b>
                  </button>
                </React.Fragment>
              );
            })}
...
function PlayerTradingCard({ profile }) {
  ...
  return (
    <button
      className={'flip-card mock-flip-card ' + (flipped ? 'is-flipped' : '')}
    ...
    >
      <div className="mock-card-inner">
        <div className="mock-card-face mock-card-front">
          <div className="mock-card-stock">
            ...
            <div className="mock-photo-window">
              <PlayerPhoto name={profile.name} src={profile.photoUrl || profile.headshotUrl} className="mock-action-photo" />
              <div className="mock-photo-grain"></div>
              <div className="mock-headshot-medal">
                <PlayerPhoto name={profile.name} src={profile.headshotUrl || profile.photoUrl} className="mock-headshot-photo" />
              </div>
            </div>

            <div className="mock-name-band">
              <div className="mock-name-copy">
                <h2>{profile.name}</h2>
                <p>★ “{title}” ★</p>
              </div>
              <div className="mock-rank-puck">#{profile.rank || cardNo}</div>
              <img src="/dgl-logo.jpeg" alt="DGL" className="mock-shield" />
            </div>
        ...
        <div className="mock-card-face mock-card-back">
          <div className="mock-card-back-stock">
            <div className="mock-back-header">
              <img src="/dgl-logo.jpeg" alt="DGL" />
              <div>
            ...
            <div className="mock-back-footer">
