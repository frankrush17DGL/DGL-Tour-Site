    ...
    >
      <div className="dgl84-card-rotor">
        <div className="dgl84-card-face dgl84-card-front">
          <div className="dgl84-card-front-stock">
            <div className="dgl84-top-ribbon"><span>DOJO GOLF LEAGUE</span><b>{edition.label}</b></div>
            ...
            <div className="dgl84-card-front-footer"><span>OFFICIAL DGL CARD</span><span>CARD #{cardNo}</span></div>
          </div>
        </div>

        <div className="dgl84-card-face dgl84-card-back">
          <div className="dgl84-card-back-stock">
            <div className="dgl84-card-back-header">
              <div className="dgl84-card-back-logo"><strong>DGL</strong><span>2026</span></div>
              <div><p>Official Player Record</p><h3>{profile.fullName || profile.name}</h3><span>{title} • Card #{cardNo}</span></div>
              <b>{rankDisplay}</b>
            </div>

            <div className="dgl84-card-back-idline"><span>{profile.hometown || 'MPLS, MN'}</span><span>{profile.handedness || 'RIGHT'}</span><span>{edition.label}</span></div>

            <div className="dgl84-card-back-columns">
            ...
            <div className="dgl84-scouting"><h4>Scouting Report</h4><p>{profile.bio || 'Bio pending. Add notes in the Players tab to complete the back of this card.'}</p></div>
            ...
            <div className="dgl84-card-back-foot"><span>Dojo Golf League</span><span>Est. 2021</span></div>
          </div>
        </div>
      </div>
    </button>
