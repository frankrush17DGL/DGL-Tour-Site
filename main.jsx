        ...
        <div className="card-face card-front retro-front">
          ...
          <div className="retro-photo-stack">
            <div className="retro-main-photo">
              <PlayerPhoto name={profile.name} src={profile.photoUrl || profile.headshotUrl} className="retro-action-photo" />
            </div>
            <div className="retro-headshot-ring">
              <PlayerPhoto name={profile.name} src={profile.headshotUrl || profile.photoUrl} className="retro-headshot-photo" />
            </div>
    ...
    <section className="red-room-page players-page card-gallery-page">
      ...
      <div className="red-page-hero annals-hero players-hero">
        <div className="red-page-copy">
          ...
          <p>Retro hockey-card fronts. Stats-only backs. Tap any card to flip.</p>
          <p className="red-subline">Uses Photo URL, Headshot URL, Card Color, Bio, Annals, Red Rounds, State Trophies, Sportsbook, and 2026 Standings.</p>
        </div>
      </div>
