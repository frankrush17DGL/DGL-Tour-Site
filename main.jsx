...
async function loadLiveData() {
  ...
  const events = safeParse('future events', [], () => parseFutureEvents(futureEventsText));
        ...
        <div className="dgl84-card-face dgl84-card-front">
          <div className="dgl84-card-paper">
            ...
            <div className="dgl84-stat-footer">
              ...
              <div><small>Points</small><b>{profile.points != null ? profile.points : '—'}</b></div>
              <div><small>Odds</small><b>{profile.odds ? formatOdds(profile.odds) : '—'}</b></div>
            </div>
          </div>
        </div>
        ...
        <div className="dgl84-card-face dgl84-card-back">
          <div className="dgl84-back-paper">
            <div className="dgl84-back-title">
              <div className="dgl84-back-logo"><strong>DGL</strong><span>2026</span></div>
            ...
            <div className="dgl84-back-foot"><span>Dojo Golf League</span><span>Est. 2021 • Card #{cardNo}</span></div>
          </div>
        </div>
      </div>
    </button>
