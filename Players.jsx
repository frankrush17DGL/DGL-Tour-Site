        ...
        <div className="dgl84-card-face dgl84-card-front">
          <div className="dgl84-card-paper">
            ...
            <div className="dgl84-name-banner">
              <div className={`dgl84-name-copy ${String(profile.name || '').length > 15 ? 'is-long-name' : ''}`}>
  ...
  return (
    <section className="red-room-page players-page card-gallery-page">
      <style>{`
        ...
        .players-page .dgl84-mini-portrait {
          ...
          box-shadow: 0 4px 12px rgba(20, 7, 3, .38);
        }
        ...
        /* Keep the larger portrait from covering either the name or nickname. */
        .players-page .dgl84-name-banner {
        ...
        .players-page .dgl84-name-banner .dgl84-name-copy {
          display: block !important;
        ...
        .players-page .dgl84-name-banner h2 {
          width: 100%;
          min-width: 0;
          margin: 0 0 6px !important;
          font-size: clamp(19px, 5vw, 29px) !important;
        ...
        .players-page .dgl84-name-banner h2 span {
          display: block !important;
        }

        .players-page .dgl84-name-banner h2 span + span::before {
          content: none;
        }

        .players-page .dgl84-name-copy.is-long-name h2 {
          font-size: clamp(17px, 4.5vw, 25px) !important;
        }

        .players-page .dgl84-name-banner p {
          display: inline-block !important;
          max-width: 100%;
          margin: 0 !important;
          padding: 4px 7px 3px !important;
          border-radius: 4px;
          background: #64170f !important;
