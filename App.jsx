...
import HomePage, { NevalaFilesPage } from './Home.jsx';
...
import FamilyScramblePage from './FamilyScramble.jsx';
...
function pageFromHash() {
  ...
  if (hash === '#nevala-files') return 'nevala-files';
  if (hash === '#players') return 'players';
  if (hash === '#family-scramble') return 'family-scramble';
  return 'home';
}
...
function App() {
  ...
  const goNevalaFiles = () => navigate('nevala-files');
  const goPlayers = () => navigate('players');
  const goFamilyScramble = () => navigate('family-scramble');
      ...
      <>
        <nav className="nav">
          ...
          <div>
            ...
            <button onClick={goNevalaFiles}>Nevala Files</button>
            <button onClick={goPlayers}>Players</button>
            <button onClick={goFamilyScramble}>Family Scramble</button>
          </div>
        </nav>
        <HomePage
          data={data}
          ...
          goNevalaFiles={goNevalaFiles}
          goPlayers={goPlayers}
          goFamilyScramble={goFamilyScramble}
        />
      </>
    );
  ...
  } else if (page === 'nevala-files') {
    content = <NevalaFilesPage data={data} goHome={goHome} />;
  } else if (page === 'players') {
    content = <PlayersPage data={data} goHome={goHome} />;
  } else if (page === 'family-scramble') {
    content = <FamilyScramblePage goHome={goHome} />;
  }
