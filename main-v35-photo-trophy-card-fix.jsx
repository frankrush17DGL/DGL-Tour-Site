...
function parsePlayers(text) {
  ...
  const indexes = {
    ...
    photoUrl: indexOf(['Photo URL', 'Photo', 'Image URL', 'Image', 'Action Photo URL', 'Action Photo', 'Main Photo', 'Main Photo URL']),
    headshotUrl: indexOf(['Headshot URL', 'Headshot', 'Head Shot URL', 'Portrait URL', 'Portrait', 'Player Headshot']),
  ...
  return rows.slice(headerIndex + 1).map(row => {
    ...
    return {
      ...
      photoUrl: normalizeAssetUrl(indexes.photoUrl >= 0 ? row[indexes.photoUrl] : row[13] || ''),
...
function parseThisDayHistory(text) {
  ...
  const indexes = {
    ...
    photoUrl: indexOf(['Photo URL', 'Photo', 'Image URL', 'Trophy Photo', 'Trophy Photo URL'])
  };
      ...
      <section className="grid">
        ...
        <article className="card sidepots-card">
          ...
          <p className="note">
            ...
            Scott Wishart<br/>
            Edinburgh Golf Course<br/>
            Hole #1 • 492-yard Par 5<br/>
            6/18/26 • Paid $77.50
          </p>
        </article>
