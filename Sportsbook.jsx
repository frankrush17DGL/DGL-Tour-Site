      ...
      <article className="dgl84-odds-board">
        ...
        <div className="dgl84-odds-table">
          <div className="dgl84-odds-header">
            <span>Rank</span><span>Player</span><span>Rating</span><span>Win %</span><span>Odds</span><span>{movementSince ? `Movement Since ${movementSince}` : 'Movement'}</span><span>Value</span>
          </div>
