...
const TOURNAMENT_CENTER_BUILD = 'TC 2026.08.03.1';
  ...
  return (
    <article className="card tc-shell" id="events">
      ...
      <div className="tc-projection-layout">
        <section className="tc-projections">
          ...
          <p className="tc-method-note">
            Starts equal with accurate GHIN handicaps, then adjusts for recent net form (12% cap) and sample-adjusted shared-round history (30% weight). American odds include the Power Model vig from J2; season points and championship odds are excluded.
          </p>
        </section>
      ...
      <style>{`
        ...
        .tc-projection-label{display:flex;justify-content:space-between;align-items:flex-start;gap:12px}.tc-projection-label>div{display:grid;gap:3px}.tc-projection-label strong{font-size:15px}.tc-projection-label small{color:#a99f8d;font-size:10px}.tc-projection-price{display:flex!important;align-items:baseline;gap:8px;text-align:right}.tc-projection-price b{color:#f0c75e;font-size:20px}.tc-projection-price em{color:#fff;font-size:12px;font-style:normal;font-weight:900}
        ...
        @media(max-width:620px){.tc-shell{padding:14px}.tc-kicker-row{align-items:flex-start;flex-direction:column}.tc-hero{min-height:500px}.tc-course-photo,.tc-course-placeholder{height:500px}.tc-hero-copy{left:16px;right:16px;bottom:22px;max-width:none}.tc-countdown{left:14px;right:14px;top:14px;min-width:0}.tc-details{align-items:stretch;flex-direction:column}.tc-actions{justify-content:stretch}.tc-actions a{flex:1}.tc-hero-copy>strong{font-size:42px}.tc-mini-grid{grid-template-columns:1fr}.tc-subhead,.tc-upcoming-head{align-items:flex-start;flex-direction:column}.tc-weather-hours{grid-template-columns:repeat(2,minmax(0,1fr))}}
