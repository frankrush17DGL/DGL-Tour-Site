...
function AnnalsPage({ data, goHome, goPlayerProfile }) {
    ...
    <section className="red-room-page annals-page annals-v2">
      ...
      <div className="annals-dashboard">
        <article className="annals-champion-card">
          ...
          <h2><PlayerLink name={yearData.champion} onSelect={goPlayerProfile} /></h2>
          <span>Champion</span>
          <div className="annals-podium">
            {podium.map(result => (
              <div className="annals-podium-player" key={result.year + result.player}>
                ...
                <span><PlayerLink name={result.player} onSelect={goPlayerProfile} /></span>
              </div>
            ))}
          </div>
        </article>
        ...
        <article className="annals-stat-card">
          ...
          <h3><PlayerLink name={yearData.topPointsPlayer} onSelect={goPlayerProfile} /></h3>
        ...
        <article className="annals-stat-card">
          ...
          {seasonTotals ? (
            <small>
              {seasonTotals.regularSeasonRounds} regular-season rounds •{' '}
              {seasonTotals.playoffRounds} playoff rounds •{' '}
              {seasonTotals.totalRounds} total rounds
            </small>
          ) : (
